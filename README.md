...
```sh
  ...
  git clone https://github.com/harshi0102/hello-rails-backend.git
```
...
Feel free to check the [issues page](https://github.com/harshi0102/hello-rails-backend/issues).
...
This project is [MIT](https://github.com/harshi0102/hello-rails-backend/blob/development/LICENSE) licensed.
